...
class Kiotviet_Woo {
	...
	private function load_dependencies() {
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-kiotviet-woo-public.php';
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Kiotviet_Woo_Public( $this->get_plugin_name(), $this->get_version() );
